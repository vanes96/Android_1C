...
public class FragmentC1 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if( !PermissionChecker.isPermissionGranted(getActivity(), CALL_PHONE_PERMISSION) ) {
            Log.i("C1Create", "No Permissons");
            ActivityCompat.requestPermissions(getActivity(), new String[] {CALL_PHONE_PERMISSION}, CALL_PHONE_REQUEST);
        }
